...
export declare const userRelations: import("drizzle-orm").Relations<"user", {
    session: import("drizzle-orm").Many<"session">;
    account: import("drizzle-orm").Many<"account">;
    verification: import("drizzle-orm").Many<"verification">;
    quiz: import("drizzle-orm").Many<"quiz">;
    jobs: import("drizzle-orm").Many<"jobs">;
    userPlans: import("drizzle-orm").Many<"user_plans">;
    featureUsage: import("drizzle-orm").Many<"feature_usage">;
}>;
export declare const verificationRelations: import("drizzle-orm").Relations<"verification", {
