...
function HomeComponent() {
  return (
    <section>
      <header className="flex items-center justify-between px-2 py-1 bg-sidebar/90 backdrop-blur-md fixed top-0 left-0 right-0 z-50 shadow">
        <div>
            <Link to="/" className="text-2xl font-bold">Xyen AI</Link>
        </div>
