        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-primary">Choose between Multiple choice, Theory or YES/NO Questions</p>
              <p className="text-xs text-muted-foreground mt-1">
                Multiple choice questions have 4 options, while Yes/No questions
                have 2 options and Theory questions have no options.
              </p>
            </div>
            ...
            {uploading && (
              <div className="space-y-2 mt-4">
                ...
                <p className="text-xs text-muted-foreground text-center mt-1">
                  Please wait while we process your document and generate quiz
                  questions
                </p>
              </div>
            )}
