...
import { Link, Navigate, useNavigate, type UseNavigateResult } from "@tanstack/react-router";
...
const VerifyEmailDialog = ({
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Please verify your email address</AlertDialogTitle>
          <AlertDialogDescription>
            ...
            <small className="text-amber-100">
              ...
              in your inbox. if no mail try logging in to resend the
              verification email.
            </small>
          </AlertDialogDescription>
        </AlertDialogHeader>
